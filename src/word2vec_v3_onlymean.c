...
/////
const int wordmeans_hash_size=30000000;
...
{  
  ...
  //基于伪随机数的算法 http://www.cnblogs.com/xkfz007/archive/2012/08/25/2656893.html
    ...
    hownet_pos=SearchVocab_Hownet(vocab[word].word);
    strcpy(means,hownet[hownet_pos].means);
    res_pos=0;
    des_pos=0;
    int temppos=0;
    ...
    {	
      	...
      	if(means[res_pos]==' ' ) 
      	{
      		mean[des_pos]='\0';
      		while(1){
      			if(wordmean[temppos]=='\0')break;
      			if(wordmean[temppos]==127)wordmean[temppos]='\0'; 
      			temppos++;
      		}
